...
u2_D.interpolate(lambda x: np.vstack((0.0 * np.ones(x.shape[1]), np.zeros((domain.geometry.dim - 1, x.shape[1])))))
...
xdmf = io.XDMFFile(domain.comm, "elasticity_2d_e2.xdmf", "w")
